use spline1d::{
    ...
    cardinal_single_left, cardinal_single_middle, cardinal_single_middle_alpha,
    cardinal_single_right, catmullrom_single_left, catmullrom_single_middle,
    catmullrom_single_middle_alpha, catmullrom_single_right, fritschbutland_single_left,
    fritschbutland_single_middle, fritschbutland_single_middle_alpha, fritschbutland_single_right,
...
fn main() {
    ...
    println!(
        "akima middle alpha at t=0.5 = {}",
        eval_alpha(1.0, 1.5, a, 0.5)
    );
    ...
    println!(
        "catmullrom middle alpha at t=0.5 = {}",
        eval_alpha(1.0, 1.5, a, 0.5)
    );
    ...
    println!(
        "cardinal middle alpha at t=0.5 = {}",
        eval_alpha(1.0, 1.5, a, 0.5)
    );
    ...
    println!(
        "fritschbutland middle alpha at t=0.5 = {}",
        eval_alpha(1.0, 1.5, a, 0.5)
    );
