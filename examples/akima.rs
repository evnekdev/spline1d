...
use spline1d::{akima, akima_single_middle, akima_single_middle_alpha};
...
fn main() {
    ...
    let coeffs = akima_single_middle(0.0, 0.0, 1.0, 1.0, 2.0, 1.5, 3.0, 1.75);
    let alpha = akima_single_middle_alpha(0.0, 0.0, 1.0, 1.0, 2.0, 1.5, 3.0, 1.75);
